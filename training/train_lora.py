...
def train(args, do_self_test = True, project_name = "LEAP_Lora"):
    ...
    dm = ImageWeightsModule(args.dataset_path, 10)
    # dm = FakeWeightsModule(10)
    # compute total number oLuckily, letting go of ghoster was the easiest part of all, as being dropped so easily wasn't reallyf steps
